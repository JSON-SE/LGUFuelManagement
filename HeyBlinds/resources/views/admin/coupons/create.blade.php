                                    ...
                                    <div class="col-lg-3 col-xl-12">
                                        <div class="row gx-2">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-floating mt-3">
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('amount') }}" placeholder="Discount Amount">
                                            ...
                                            <div class="col-lg-2 d-none">
                                                <div class="form-floating mt-3">
                                                    <input type="text"
                                                        class="form-control  {{ $errors->has('min_quantity') ? ' bg-light-danger' : '' }} @error('min_amount') is-invalid @enderror"
                                                        id="min_quantity" name="min_quantity"
                                                        value="{{ old('min_quantity') }}" placeholder="Minimum Quantity">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-floating mt-3">
                                                    <input type="datetime-local" class="form-control" id="start_date"
                                                        name="start_date" required value="{{ old('start_date') }}" step="1"
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-floating mt-3">
                                                    <input type="datetime-local"
                                                        ...
                                                        name="end_date" required value="{{ old('end_date') }}" step="1"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="mt-3">
                                                    ...
                                                    <textarea id="summernote-excerpt" name="description" class="summernote"
                                                        {{ $errors->has('description') ? ' bg-light-danger' : '' }}
