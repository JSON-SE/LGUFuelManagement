...
@section('content')
    <div class="container-fluid px-lg-5 px-md-4 pb-5 pt-lg-3">
        ...
        <form action="{{route('admin.product.option.group.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row pt-4">
                <div class="col-12">
            ...
            <div class="row pb-4">
                <div class="col-sm-6 text-white my-auto">
                    ...
                    <h3 class="mb-0">Create Option Group</h3>
                </div>
                        ...
                        <div class="color-records pb-3">
                            <div class="row">
                                <div class="col-lg-12 col-xl-12">
                                    <div class="row gx-2">
                                        <div class="col-lg-3 ">
                                            <label for="group_name" class="pb-2">Option Group Name <span class="text-danger">*</span></label>
                                            <input type="text" name="name" class="form-control" id="group_name" value="{{old('name')}}"
                                        ...
                                        <div class="col-lg-3 ">
                                            ...
                                            <select type="text" name="group_heading" class="form-control" id="group_heading">
                                                ...
                                                @foreach($groupNames as $groupName)
                                                    <option value="{{$groupName->group_heading}}">{{$groupName->group_heading}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-lg-1 my-auto">
                                            <div class="check-box ms-4">
                                                <input type="checkbox" id="is_enable" name="is_enabled"
                                                       value="1" {{old('is_enabled') == 1 ? "checked": (!empty(old('is_enabled')) && old('is_enabled') == 0 ? "" : "checked")}} >
                                        ...
                                        <div class="col-lg-2 my-auto">
                                            <div class="check-box ms-4">
                                                <input type="checkbox" id="show_group_name" name="show_group_name"
                                                       value="1" {{old('show_group_name') == 1 ? "checked": (!empty(old('show_group_name')) && old('show_group_name') == 0 ? "" : "checked")}} >
                                        ...
                                        <div class="col-lg-12 col-md-6 col-sm-6 col-6 mt-3">
                                            ...
                                            <div class="mt-2 pe-4">
                                                <textarea name="content" id="body-content" cols="2" rows="2" class="summernote">{{old('content')}}</textarea>
                                            </div>
                                        </div>
                                    </div>
