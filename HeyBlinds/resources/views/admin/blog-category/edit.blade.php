...
<div class="container-fluid px-lg-5 px-md-4 pb-5 pt-lg-3">
    ...
    <div class="row pb-4">
        <div class="col-sm-6 text-white my-auto">
            <h3 class="mb-0">Edit: {{ $blogCategory->name }}</h3>
        </div>
                        ...
                        <div class="row gx-2">
                            <div class="col-lg-6 mb-3">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Category Name" value="{{ $blogCategory->name }}" required>
