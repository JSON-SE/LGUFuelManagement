...
<section id="body-content" class="">
    <div class="container-fluid px-lg-5 px-md-4 pb-5 pt-lg-3">
        ...
        <div class="col-sm-6 pt-3 pt-lg-0 my-auto d-flex justify-content-sm-end">
            ...
            <a href="{{route('admin.blog-category.create')}}" class="btn btn-primary d-flex align-items-center">
        ...
        <div class="bg-white rounded page-height mt-3 shadow">
            <div class="p-lg-4 p-3">
                <div class="table-responsive mt-2">
                    <table class="table table-striped w-100" id="blogCategory-table">
...
<script type="text/javascript">
    function deleteBlogCategory(id) {
        if (!confirm('Are you sure you want to delete this item')) return false;
            axios.delete(`/admin/blog-category/${id}`).then((response)=>{
                if(response.data.status ===true){
                    $('#blogCategory-table').DataTable().ajax.reload();
