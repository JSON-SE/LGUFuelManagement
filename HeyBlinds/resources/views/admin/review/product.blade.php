...
<section id="body-content" class="">
            ...
            <div class="bg-white rounded page-height mt-3 shadow">
                <div class="p-lg-4 p-3">
                    ...
                    <div class="table-responsive mt-2">
                        <table class="table table-striped w-100" id="product-review-table">
    ...
    <script>
        jQuery(document).ready(function () {
            $('#product-review-table').DataTable({
                processing: true,
                serverSide: true,
                ordering : false,
                "iDisplayLength": 100,
                ...
                columns: [
                    ...
                    { data: 'customer_suggestion', name: 'customer_suggestion', },
    ...
    <script type="text/javascript">
       function checkedUnchecked (review_id) {
           ...
           axios.post(`/admin/product-review/show-home-page`,{
        ...
        function reviewDelete(id){
            ...
            axios.delete(`/admin/review/product/delete/${id}`).then((response)=>{
                if(response.data.status ===true){
                    $('#product-review-table').DataTable().ajax.reload();
                }
            })
            return true;
        }
