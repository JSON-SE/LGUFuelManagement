...
@section('title')
    Blackout Window Blinds & Shades | HeyBlinds Canada
@endsection
@section('content')
                                ...
                                <div class="col-lg-3 col-md-4 col-6">
                                    <div class="checkbox img-checkbox">
                                        ...
                                        <label for="colour_{{ $colorGroup->id }}">
                                            ...
                                            {{ $colorGroup->name }}
                                            {{-- <small class="ps-1">
                                                ({{ !$isSubCategory ? $helpers->productCountAsPerColor($category->id, $colorGroup->id) : $helpers->productCountAsPerColorForSub($colorGroup->id, $subCategory->id) }})</small> --}}
                                        </label>
                                    </div>
                                </div>
                            @endif
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="row pb-2">
                            ...
                            @else
                                <div class="container pt-2 pb-4 pb-xxl-5 text-center error-section">
                                    <div class="error-box">
                                        <img src="https://prod.heyblinds.ca/images/404-image.jpg" alt="">
                                        <div class="eye"></div>
                                    </div>
                    ...
                    <div class="col-lg-8 col-md-7 pb-3">
                        ...
                        <p class="">@php echo !$isSubCategory ? $category->content  : $subCategory->content @endphp</p>
                            ...
                            <img class="rounded-3" src="{{ asset('images/product-image.jpg') }}" alt="" />
                    </div>
                </div>
                @endif --}}
                </div>
    ...
    @push('js')
        <script>
            ...
            function filters() {
                ...
                $("#loader").show();
                let url = '{{ route('frontend.blackout.product.search') }}';
