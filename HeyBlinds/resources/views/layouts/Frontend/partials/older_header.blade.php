                                    ...
                                    @guest
                                        <div>
                                            ...
                                            <form autocomplete="off" class="">
                                                ...
                                                <div class="text-end"><a href="{{ url('/forgot-password') }}">Forgot
                                                        Your Password?</a></div>
                                            ...
                                            <div class="text-center">
                                                <a href="{{ url('order-tracking') }}" class="btn btn-primary btn-sm">Track
                                                    Order</a>
                                            </div>
                                        </div>
                                    @else
                                    ...
                                    <nav>
                                        <ul class="nav-menu">
                                            @foreach ($categories as $category)
                                                @if (!empty($category->product) && $category->product->count() > 0 && $helpers->checkIsProductExist($category->id, 'category'))
                                        ...
                                        <ul class=" nav-menu d-block d-lg-none">
                                            <hr />
                                            <li><a class=""
                                                    href="{{ route('frontend.warranty') }}">HeyOK Warranties</a></li>
                                            <li><a class=""
                                                    href="{{ route('frontend.free_shipping') }}">Free Shipping On
                                                    Everything</a></li>
                                        </ul>
                                    </nav>
                                </div>
...
<div class="header-bottom">
    <div class="bg-secondary promoTier text-center text-white">
        @if (!empty($headerCoupon))
            <div class="container py-2 pe-4">
                <p class="promoTier-text">
                    {{-- Save {{$headerCoupon->amount}}% on All + Take an Extra 15% Most Popular - --}}
                    {{-- @if ($headerCoupon->type == 'percentage') --}}
                    {{-- Save {{ $headerCoupon->amount }}% on All + Take an Extra 10% Off Orders over $500 with Coupon VICTORIA10 at Checkout - --}}
                    {{-- @else --}}
                    {{-- Save {{ $headerCoupon->amount }}$ on All + Take an Extra 10% Off Orders over $500 with Coupon VICTORIA10 at Checkout - --}}
                    {{-- @endif --}}

                    {{-- Save 55% Off Everything + Save an Extra 10% Off Orders over $500 with Coupon VICTORIA10 at Checkout. Ends Thursday. --}}
                    Save 55% Off Everything + Enter Coupon SUMMER10 at checkout for an Extra 10% Off Orders Over $500.
                    Ends Wednesday.
                    {{-- Save 55% Off Everything + Save an Extra 10% Off Orders over $500 with Coupon VICTORIA10 at Checkout. Ends Wednesday. --}}
                    {{-- <span class="mx-2"><b> SHOP NOW <span>»</span> </b></span> --}}
                    {{-- <a class="text-decoration-underline ms-2" href="#" id="couponDetails"> Details</a> --}}
                </p>
...
<script>
    var deadline = "{{ @$headerCoupon->end_date }}";
    ...
    $("#couponDetails").on("click", function(event) {
        ...
        // $("#modelCouponDescription").text(text);
        // text = "{{ @$headerCoupon->description }}";
        // $("#modelCouponDescription").text(text);
