...
<head>
    ...
    <!-- Style sheet import -->
    <link rel="stylesheet" id="bootstrap-css" href="{{ asset('admin/css/bootstrap.min.css') }}" type="text/css"
        media="all" />
    <link rel="stylesheet" id="style-css" href="{{ asset('admin/css/dataTables.bootstrap5.min.css') }}"
        type="text/css" media="all" />
    <link rel="stylesheet" id="style-css" href="{{ asset('admin/css/toastr.min.css') }}" type="text/css"
        media="all" />
    <link rel="stylesheet" id="style-css" href="{{ asset('admin/css/summernote.min.css') }}" type="text/css"
        media="all" />
    ...
    <link rel="stylesheet" id="dropzone-min" href="{{ asset('admin/css/dropzone.min.css') }}" type="text/css" media="all" />
        ...
        <nav class="navbar navbar-expand-lg navbar-overlap navbar-dark bg-dark px-lg-5 px-md-4">
            <div class="container-fluid d-flex position-relative">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown">
                        <button
                            class="btn profile-btn dropdown-toggle p-0 text-white border-0 d-flex align-items-center"
                            type="button" id="profile" data-display="static" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <span class="user-image me-1">
                                <img src="{{ asset('admin/images/auth-image.jpg') }}" alt="" />
                            </span>
...
<script type='text/javascript' src="{{ asset('admin/js/totalscrpit.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ asset('admin/js/tinymce.min.js') }}"></script>
