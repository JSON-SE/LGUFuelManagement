...
class SampleOrderAdminNotification extends Notification implements  ShouldQueue
{
    use Queueable;
    public $shipping;
    ...
    public function toMail($notifiable)
    {
        ...
        ->subject('Alert: Over 12 samples ordered '.$this->order_id)
        ->bcc('help@heyblinds.ca')
