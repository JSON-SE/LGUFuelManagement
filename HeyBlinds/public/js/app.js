...
//require("jquery");
var bootstrap = __webpack_require__(/*! bootstrap */ "./node_modules/bootstrap/dist/js/bootstrap.esm.js"); //require("@popperjs/core");
//require("slick-carousel");
//require("resize-sensor");


__webpack_require__(/*! theia-sticky-sidebar */ "./node_modules/theia-sticky-sidebar/dist/theia-sticky-sidebar.js"); //require("toastr");
...
$(function () {
  $("form, input, select").attr("autocomplete", "nope"); // --------header fixed
  ...
  if ($(".view_password_option")) {
    $(".toggle-password").on("click", function () {
      ...
      var input = $(this).next(".view_password");
...
success_callback = function success_callback(url) {
  ...
  var errors = arguments.length > 3 ? arguments[3] : undefined;
...
signin = function signin(e) {
  ...
  axios.post("/user/form-cart-login", data).then(function (response) {
...
$(document).on("click", "#finalizeSampleCart", function () {
  var sampleCartId = readCookie("__sb_sample_cart");
...
removeCartButton = function removeCartButton() {
  var displayCart = $("#sample-page-cart-right");
  var allProduct = displayCart.find(".samples-cart-list-box");
...
removeCart = function removeCart(data, $this) {
  var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "";
  axios.post("/product/" + data.pid + "/sample-remove-from-cart", data).then(function (response) {
    var data = response.data;
    var a = 0;
    var existing = parseInt($("#sampleCartCountBadge").text());
    ...
    if (type === "cart") {
      $this.parents(".samples-cart-list").remove(); // const a = $('.samples-cart-list').length;

      if (existing == 1) {
        $("#sample-page-cart-right").remove();
        $(".samples-cart-list-box").append("<div> <h4>No Sample Found</h4> </div> </div>");
        $("#finalizeSampleCart").attr("disabled", "disabled");
      }
    } else if (type === "samples") {
      var totalProductCount = $(".samples-cart-list-box[data-pid='" + data.pid + "']").find(".samples-cart-list[data-pid='" + data.pid + "']");
      ...
      $this.removeClass("btn-outline-primary btn-primary").addClass("btn-outline-primary").removeAttr("selected").text("Order Free Sample");
    }
  })["catch"](function (error) {
